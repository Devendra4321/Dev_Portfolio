...
Proven success in designing high-performance, reusable components, integrating AWS S3 securely, and enhancing digital experiences. Passionate about performance optimization and clean code in agile, team-oriented environments.`,
  ...
  socialLinks: [
    { name: 'LinkedIn', icon: 'pi pi-linkedin', url: 'https://linkedin.com/in/devendrabhole/' },
    { name: 'GitHub', icon: 'pi pi-github', url: 'https://github.com/Devendra4321' },
    { name: 'Instagram', icon: 'pi pi-instagram', url: 'https://www.instagram.com/mr_devendra_45/?hl=en' },
    { name: 'Facebook', icon: 'pi pi-facebook', url: 'https://www.facebook.com/devendra.bhole.33' },
  ]
};
